...
vim.keymap.set('n', '<M-d>', vim.diagnostic.open_float, { desc = 'Open diagnostic [L]ocation list' })
...
require('lazy').setup({
    ...
    },
    {
        ...
        config = function()
            ...
            --  - fletypes (table): Override the default list of associated filetypes for the server
